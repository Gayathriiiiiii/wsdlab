...
// myapp.controller("mca1",function($scope,$http)
// {
// 	$scope.rowlimit=5;
//     $scope.fullName ;
//     $scope.today = new Date();

//     $http.get('https://gayathriiiiiii.github.io/wsdlab/employee.json')
...
//     $http.get('https://pvr001.github.io/EMPLOYEE-MANAGEMENT/employee.json')
//     .success(function(response)
//     {
//         $scope.names=response.Employee;
